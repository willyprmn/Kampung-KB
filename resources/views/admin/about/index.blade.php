    ...
    <div class="row mb-2">
        ...
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><a href="#">Tentang Program</a></li>
...
@section('content')
<div class="container-fluid">
    <h1 class="px-3">Tentang Program</h1>
    {!! Form::open([
                            ...
                            <div class="form-group">
                                ...
                                <div class="sona-container">
                                    <fieldset id="fieldsetKegiatan">
                                        <div class="sonas">
                                            <div class="sona">
                                                <img class="preview-image" src="{{ old('image.base64') ?? $image['base64'] ?? asset('images/infografik.jpg') }}" alt="Preview">
