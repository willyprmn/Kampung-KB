...
use Cache;
use App\Models\Portal\Statistik\KepemilikanPokja;
...
class KepemilikanPokjaDataTable extends CachedDataTable
{
     ...
     *
     * @param \App\Models\Portal\Statistik\KepemilikanPokja $model
...
JAVASCRIPT
            ...
            ->drawCallback("function() {
                ...
                $('#datatable').on( 'draw.dt', function () {
                    ...
                    $('#datatable').append('<tr id=" . '"total"' . "name=" . '"total"' . " style=". '"font-weight:bold; "' . " class=". '"even"' . "> " .
                        ...
                        "<td class=".'colnum'.">' + sumAda  + ' </td> <td class=".'colnum'.">' + ((isNaN(sumAdaPersen)) ? 0 : parseFloat(sumAdaPersen).toFixed(2))  + '</td> ".
                        "<td class=".'colnum'.">' + sumTidakAda  + '</td> <td class=".'colnum'.">' + ((isNaN(sumTidakAdaPersen)) ? 0 : parseFloat(sumTidakAdaPersen).toFixed(2))  + '</td> ".
                        "<td class=".'colnum'.">' + sumBelumAda  + '</td> <td class=".'colnum'.">' + ((isNaN(sumBelumAdaPersen)) ? 0 : parseFloat(sumBelumAdaPersen).toFixed(2))  + '</td> ".
    ...
    {
        return 'kepemilikan-pokja-table_' . date('YmdHis');
    }
}
