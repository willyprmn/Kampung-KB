...
class InpresDataAdministrasiDataTable extends CachedDataTable
{
    ...
    public function query()
    {
        ...
        $data = Cache::remember($key, config('kpkb.statistik.cache.lifetime'), function (){
            ...
            $sql = file_get_contents(base_path('database/sql/statistik/intervensi/inpres-kegiatan/table1_data_administrasi.sql'));
            #alias table master
            $provinsi = "d";
            $kabupaten = "e";
            $kecamatan = "f";
    ...
    protected function getColumns()
    {
        return [
            ...
            'rumah_dataku' => [
                'title' => 'Rumah Data Kependudukan dan Informasi Keluarga (Rumah DataKu)',
                'orderable' => false,
                'className' => 'colnum',
            ],
            'administrasi' => [
    ...
    {
        return 'statistik-intervensi-data dan administrasi-' . date('YmdHis');
    }
}
