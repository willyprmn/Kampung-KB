...
class InpresPeningkatanCakupanDataTable extends CachedDataTable
{
    ...
    public function query()
    {
        ...
        $request['statistic'] = 'inpres-peningkatan-cakupan';
        $key = md5(json_encode($request));

        #set 1 day expired cache
        $data = Cache::remember($key, config('kpkb.statistik.cache.lifetime'), function (){

            $sql = file_get_contents(base_path('database/sql/statistik/intervensi/inpres-kegiatan/table5_peningkatan_cakupan.sql'));
            #alias table master
            $provinsi = "d";
            $kabupaten = "e";
            $kecamatan = "f";
    ...
    protected function getColumns()
    {
        return [
            ...
            'pendidikan_menengah' => [
                'title' => 'Pemberian Pendidikan Dasar dan Menengah',
                'orderable' => false,
                'className' => 'colnum',
            ],
            'pendikan_agama' => [
                'title' => 'Pendidikan Agama bagi masyarakat',
                'orderable' => false,
                'className' => 'colnum',
            ],
            'informasi_fasilitas' => [
                'title' => 'Pemberian informasi dan fasilitasi akses pelayanan pendidikan',
                'orderable' => false,
                'className' => 'colnum',
            ],
            'bantuan_pendidikan' => [
                'title' => 'Pemberian bantuan pendidikan keluarga dengan status miskin ',
                'orderable' => false,
                'className' => 'colnum',
            ],
            'pendidikan_literasi' => [
                'title' => 'Penyelenggaraan pendidikan literasi non formal',
                'orderable' => false,
                'className' => 'colnum',
            ],
            'wahana_kreatifitas' => [
                'title' => 'Penyelenggaraan wahana kreatifitas dan olahraga',
                'orderable' => false,
                'className' => 'colnum',
            ],
            'kegiatan_1' => [
                'title' => 'Melaksanakan 1-2 Kegiatan',
                'orderable' => false,
                'className' => 'colnum',
            ],
            'kegiatan_2' => [
                'title' => 'Melaksanakan 3-5 Kegiatan',
                'orderable' => false,
                'className' => 'colnum',
            ],
            'kegiatan_3' => [
                'title' => 'Melaksanakan 6-7 Kegiatan',
                'orderable' => false,
                'className' => 'colnum',
            ],
            'tidak_isi' => [
