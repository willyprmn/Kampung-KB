...
class InpresGermasKomunikasiDataTable extends CachedDataTable
{
    ...
    public function query()
    {
        ...
        $request['statistic'] = 'inpres-germas-komunikasi';
        $key = md5(json_encode($request));

        #set 1 day expired cache
        $data = Cache::remember($key, config('kpkb.statistik.cache.lifetime'), function (){

            $sql = file_get_contents(base_path('database/sql/statistik/intervensi/inpres-kegiatan/table2_germas_komunikasi.sql'));
            #alias table master
            $provinsi = "d";
            $kabupaten = "e";
            $kecamatan = "f";
    ...
    protected function getColumns()
    {
        return [
            ...
            'germas' => [
                'title' => 'Program Gerakan Masyarakat Hidup Sehat (GERMAS)',
                'orderable' => false,
                'className' => 'colnum',
            ],
            'pispk' => [
                'title' => 'Program Indonesia Sehat dengan Pendekatan Keluarga (PISPK)',
                'orderable' => false,
                'className' => 'colnum',
            ],
            'bkb' => [
                'title' => 'Bina Keluarga Balita (BKB)',
                'orderable' => false,
                'className' => 'colnum',
            ],
            'bkr' => [
                'title' => 'Bina Keluarga Remaja (BKR)',
                'orderable' => false,
                'className' => 'colnum',
            ],
            'bkl' => [
                'title' => 'Bina Keluarga Lansia (BKL)',
                'orderable' => false,
                'className' => 'colnum',
            ],
            'pikr' => [
            ...
            'edukasi_kie' => [
                'title' => 'Komunikasi, Informasi dan Edukasi (KIE) <br/>Kesehatan Reproduksi <br/>dan Keluarga Berencana bagi Keluarga',
                'orderable' => false,
                'className' => 'colnum',
            ],
            'pengantin' => [
                'title' => 'Bimbingan Calon Pengantin',
                'orderable' => false,
                'className' => 'colnum',
            ],
            'keagamaan' => [
                'title' => 'Bimbingan, penyuluhan dan konsultasi keagamaan',
                'orderable' => false,
                'className' => 'colnum',
            ],
            'kie_pencegahan' => [
                'title' => 'KIE Pencegahan, Perlindungan Perempuan <br/>dan Anak dari kekerasan',
                'orderable' => false,
                'className' => 'colnum',
            ],
            'advokasi_kie' => [
                'title' => 'Advokasi dan KIE pemberian makan bayi <br/>dan anak ASI eksklusif',
                'orderable' => false,
                'className' => 'colnum',
            ],
            'ktr' => [
                'title' => 'Kawasan Tanpa Rokok (KTR) <br/>dan implementasi Rumah Tanpa Asap Rokok',
                'orderable' => false,
                'className' => 'colnum',
            ],
            'kegiatan_1' => [
                'title' => 'Melaksanakan 1-4 Kegiatan',
                'orderable' => false,
                'className' => 'colnum',
            ],
            'kegiatan_2' => [
                'title' => 'Melaksanakan 5-8 Kegiatan',
                'orderable' => false,
                'className' => 'colnum',
            ],
            'kegiatan_3' => [
                'title' => 'Melaksanakan 9-12 Kegiatan',
                'orderable' => false,
                'className' => 'colnum',
            ],
            'kegiatan_4' => [
                'title' => 'Melaksanakan 4 Kegiatan Poktan <br/> (BKB, BKR, BKL, PIK R)',
                'orderable' => false,
                'className' => 'colnum',
            ],
            'tidak_isi' => [
    ...
    {
        return 'statistik-intervensi-germas-komunikasi' . date('YmdHis');
    }
}
