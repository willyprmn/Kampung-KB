...
class InpresPkbmUkbmDataTable extends CachedDataTable
{
    ...
    public function query()
    {
        ...
        $request['statistic'] = 'inpres-pkbm-ukbm';
        $key = md5(json_encode($request));

        #set 1 day expired cache
        $data = Cache::remember($key, config('kpkb.statistik.cache.lifetime'), function (){

            $sql = file_get_contents(base_path('database/sql/statistik/intervensi/inpres-kegiatan/table3_pkbm_ukbm.sql'));
            #alias table master
            $provinsi = "d";
            $kabupaten = "e";
            $kecamatan = "f";
    ...
    protected function getColumns()
    {
        return [
            ...
            'kesehatan_reproduksi' => [
                'title' => 'Penggerakan Pelayanan Keluarga Berencana dan Kesehatan Reproduksi',
                'orderable' => false,
                'className' => 'colnum',
            ],
            'edukasi_kesehatan' => [
                'title' => 'Edukasi kesehatan ibu hamil, balita, remaja, dan lansia',
                'orderable' => false,
                'className' => 'colnum',
            ],
            'pembinaan_posyandu' => [
                'title' => 'Melakukan pembinaan posyandu',
                'orderable' => false,
                'className' => 'colnum',
            ],
            'posyandu_aktif' => [
                'title' => 'Melaksanakan Posyandu Aktif',
                'orderable' => false,
                'className' => 'colnum',
            ],
            'kespro' => [
                'title' => 'Pelayanan Keluarga Berencana (KB) dan Kespro',
                'orderable' => false,
                'className' => 'colnum',
            ],
            'p2k2' => [
            ...
            'kegiatan_2' => [
                'title' => 'Melaksanakan 3-4 Kegiatan',
                'orderable' => false,
                'className' => 'colnum',
            ],
            'kegiatan_3' => [
                'title' => 'Melaksanakan 5-6 Kegiatan',
                'orderable' => false,
                'className' => 'colnum',
            ],
            'tidak_isi' => [
