...
class PokjaKampungKbTerlatihDataTable extends CachedDataTable
{
    ...
    public function query()
    {
        ...
        $data = Cache::remember($key, config('kpkb.statistik.cache.lifetime'), function (){
            ...
            $sql = file_get_contents(base_path('database/sql/statistik/pokja/kampung-terlatih.sql'));
            #alias table master
            $provinsi = "c";
            $kabupaten = "d";
            $kecamatan = "e";
