...
use Cache;
use App\Models\Portal\Statistik\KepemilikanRumahDataku;
...
class KepemilikanRumahDatakuDataTable extends CachedDataTable
{
     ...
     *
     * @param \App\Models\Portal\Statistik\KepemilikanRumahDataku $model
...
JAVASCRIPT
    ...
    {
        return 'kepemilikan-rumah-dataku-table_' . date('YmdHis');
    }
}
