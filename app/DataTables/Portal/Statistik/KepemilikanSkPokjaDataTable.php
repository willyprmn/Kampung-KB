...
use Cache;
use App\Models\Portal\Statistik\KepemilikanSkPokja;
...
class KepemilikanSkPokjaDataTable extends CachedDataTable
{
     ...
     *
     * @param \App\Models\Portal\Statistik\KepemilikanSkPokja $model
...
JAVASCRIPT
    ...
    {
        return 'kepemilikan-sk-pokja-table_' . date('YmdHis');
    }
}
