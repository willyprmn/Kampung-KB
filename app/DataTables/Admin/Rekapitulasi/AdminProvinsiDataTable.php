...
class AdminProvinsiDataTable extends CachedDataTable
{
    /**
    ...
    {
        return $this->builder()
            ->setTableId('admin-rekap-provinsi-table')
    ...
    {
        return 'Rekapitulasi - Admin Provinsi ' . date('YmdHis');
    }
}
