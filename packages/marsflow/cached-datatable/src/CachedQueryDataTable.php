...
class CachedQueryDataTable extends DataTableAbstract
{
    ...
    public function make($mDataSupport = true)
    {
        ...
        try {
            ...
            $tags = get_class($this->query->getModel());
            ...
            $this->prepareQuery();
            $data = Cache::tags([$tags])->remember($key, 300, function () use ($mDataSupport) {
                $results   = $this->results();
                $processed = $this->processResults($results, $mDataSupport);
                return $this->transform($results, $processed);
            });
